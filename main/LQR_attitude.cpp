...
void LQR_attitude::compute(const Attitude_angle& attitude, const rotationspeed& rotSpeed, const AttitudeSetpoint& attSetpoint, ControlOutput_attitude& ctrlOutput){
    /*
